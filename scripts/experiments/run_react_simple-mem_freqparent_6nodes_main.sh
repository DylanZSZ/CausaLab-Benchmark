...
export OUTPUT_TAG="${OUTPUT_TAG:-freqparent_6nodes_main}"
export OUTPUT_ROOT_PREFIX="${OUTPUT_ROOT_PREFIX:-obs_CausalFreqParent}"
export SETTING_DIR_NAME="${SETTING_DIR_NAME:-6nodes_main}"
export MODEL="${MODEL:-gpt-5-mini}"
export CAUSAL_GRAPH_GROUP="${CAUSAL_GRAPH_GROUP:-6nodes_freqparent.jsonl}"
