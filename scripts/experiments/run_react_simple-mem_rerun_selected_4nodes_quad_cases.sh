...
ROOT="${ROOT:-$(repo_root)}"
SOURCE_GRAPH_GROUP="${SOURCE_GRAPH_GROUP:-$ROOT/causal_graph_configs/4nodes_quad.jsonl}"

export GRAPH_IDS_CSV="${GRAPH_IDS_CSV:-4nodes_quad_12,4nodes_quad_17,4nodes_quad_21,4nodes_quad_23,4nodes_quad_25,4nodes_quad_28,4nodes_quad_29,4nodes_quad_32,4nodes_quad_39}"
export OUTPUT_TAG="${OUTPUT_TAG:-rerun_selected_4nodes_quad_failed_cases}"
export EXPERIMENT_FAMILY="${EXPERIMENT_FAMILY:-quad_eval_rerun_selected}"
export NODE_COUNT="${NODE_COUNT:-4}"

TEMP_GRAPH_GROUP="$(mktemp "${TMPDIR:-/tmp}/rerun_selected_4nodes_quad_XXXXXX.jsonl")"
cleanup_temp_group() {
...
echo "============================================================================"
echo "Rerunning selected 4-node quadratic cases"
...
bash "$SCRIPT_DIR/run_react_simple-mem_4nodes_quad.sh"
