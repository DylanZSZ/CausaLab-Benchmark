...
export EXPERIMENT_FAMILY="${EXPERIMENT_FAMILY:-quad_eval}"
export OUTPUT_TAG="${OUTPUT_TAG:-${TS}_dsl_quad}"
export MODEL="${MODEL:-gpt-5-mini}"
export NODE_COUNT="${NODE_COUNT:-4}"
export CAUSAL_GRAPH_GROUP="${CAUSAL_GRAPH_GROUP:-4nodes_quad.jsonl}"
...
export BASE_OUTPUT_DIR_OVERRIDE="${BASE_OUTPUT_DIR_OVERRIDE:-$ROOT/output_dir/react_simple-mem/obs_CausalQuad_gpt-5-mini/4nodes_quad}"
