...
from discoveryworld.ScienceHelpers import (
    getNPKContent,
    getAveragePH,
    getRadiationLevelAroundLocation,
)
...
class Microscope(Object):
    ...
    def actionUseWith(self, patientObj):
        ...
        microscopeDescriptionStr = (
            "You use the microscope to observe the " + patientObj.name + ".\n"
        )
        ...
        return ActionSuccess(
            True, microscopeDescriptionStr, importance=MessageImportance.HIGH
        )
...
class NPKMeter(Object):
    ...
    def __init__(self, world):
        Object.__init__(
            ...
            "NPK field test",
            "NPK field test",
            defaultSpriteName="instruments_npk_fieldtest",
        )
    ...
    def actionUseWith(self, patientObj):
        # Use this object on the patient object
        useDescriptionStr = (
            "You use the NPK field test to investigate the " + patientObj.name + ".\n"
        )
        ...
        useDescriptionStr += (
            "The screen on the field test reports the following numbers: \n"
        )
...
class PetriDish(Object):
    ...
    def __init__(self, world):
        ...
        Object.__init__(
            ...
            "petri dish",
            "petri dish",
            defaultSpriteName="instruments_petri_dish_empty",
        )
        ...
        self.attributes["isOpenable"] = (
            False  # Can not be opened (things are stored in the open pot)
        )
    ...
    def getTextDescription(self):
        ...
        outStr = (
            " ".join(addedProperties)
            + " "
            + self.name
            + postModifier
            + self._getContainerTextDescription()
        )
        outStr = outStr.strip()
        return outStr
...
class PHMeter(Object):
    ...
    def actionUseWith(self, patientObj):
        # Use this object on the patient object
        useDescriptionStr = (
            "You use the PH meter to investigate the " + patientObj.name + ".\n"
        )
        ...
        if averagePH == None:
            ...
            return ActionSuccess(
                True, useDescriptionStr, importance=MessageImportance.HIGH
            )
        ...
        # Report the PH (to 1 decimal place(s)
        useDescriptionStr += (
            "The PH meter reports a PH of " + "{:.1f}".format(averagePH) + ".\n"
        )
...
class RadiationMeter(Object):
    ...
    def actionUseWith(self, patientObj):
        # Use this object on the patient object
        useDescriptionStr = (
            "You use the radiation meter to investigate the " + patientObj.name + ".\n"
        )

        # Get the patient object, and all its parts
        # def getAllContainedObjectsAndParts(self, includeContents=True, includeParts=True):
        patientObjAndParts = patientObj.getAllContainedObjectsAndParts(
            includeContents=False, includeParts=True
        )
        # Collect the materials of the object and its parts
        patientMaterials = []
        for patientObjOrPart in patientObjAndParts:
        ...
        backgroundRadiation = (
            self.rng.random() * self.world.parameters["avgRadiationBackgroundLevelUSVH"]
        )
        ...
        backgroundNearLocation = getRadiationLevelAroundLocation(
            self.world,
            self.attributes["gridX"],
            self.attributes["gridY"],
            excludeObject=patientObj,
            windowSize=5,
        )
        ...
        useDescriptionStr += (
            "The radiation meter reports a level of "
            + "{:.2f}".format(radiationLevelMicroSeivertsPerHour)
            + " micro Seiverts per hour.\n"
        )
...
class Sample(Object):
    ...
    def __init__(self, world, parentObject):
        ...
        Object.__init__(
            ...
            world,
            "sample",
            "sample of " + parentObject.name,
            defaultSpriteName="instruments_sample",
        )

        # Materials
        # Deep copy the materials from the parent object
        self.attributes["materials"] = copy.deepcopy(
            parentObject.attributes["materials"]
        )
        ...
        self.attributes["isPoisonous"] = (
            parentObject.attributes["isPoisonous"]
            if ("isPoisonous" in parentObject.attributes)
            else False
        )
        self.attributes["temperatureC"] = (
            parentObject.attributes["temperatureC"]
            if ("temperatureC" in parentObject.attributes)
            else 20.0
        )
...
class Sampler(Object):
    ...
    def __init__(self, world):
        Object.__init__(
            self, world, "sampler", "sampler", defaultSpriteName="instruments_sampler"
        )
    ...
    def actionUseWith(self, patientObj):
        ...
        if self.parentContainer == None:
            ...
            useDescriptionStr = (
                "You use the sampler to take a sample of the "
                + patientObj.name
        ...
        # Case 3: The sampler is in/on a container
            ...
            useDescriptionStr = (
                "You use the sampler to take a sample of the "
                + patientObj.name
                + ".\n The sample has been placed in/on the "
                + self.parentContainer.name
                + ".\n"
            )
            self.parentContainer.addObject(petriDish)
...
class Spectrometer(Object):
    ...
    def actionUseWith(self, patientObj):
        # Use this object on the patient object
        useDescriptionStr = (
            "You use the spectrometer to examine the " + patientObj.name + ".\n"
        )
        ...
        for i in range(spectrumLength):
            ...
            useDescriptionStr += (
                "- Channel " + str(i + 1) + ": " + "{:.2f}".format(spectrum[i]) + "\n"
            )
...
class Thermometer(Object):
    ...
    def __init__(self, world):
        Object.__init__(
            ...
            "thermometer",
            "thermometer",
            defaultSpriteName="instruments_thermometer",
        )
    ...
    def actionUseWith(self, patientObj):
        # Use this object on the patient object
        useDescriptionStr = (
            "You use the thermometer to measure the temperature of the "
            + patientObj.name
            + ".\n"
        )
        ...
        useDescriptionStr += (
            "The thermometer reports a temperature of "
            + "{:.2f}".format(patientTemperature)
            + " degrees Celsius.\n"
        )
...
class Densitometer(Object):
    ...
    def actionUseWith(self, patientObj):
        ...
        # Use this object on the patient object
        useDescriptionStr = (
            "You use the densitometer to examine the " + patientObj.name + ".\n"
        )
        ...
        useDescriptionStr += (
            ...
            + "{:.3f}".format(patientObj.attributes["density"])
...
class MoistureMeter(Object):
    """
    Moisture meter for measuring moisture content in objects.
    Used in causal discovery scenarios to measure the 'moisture' attribute.
    """
    ...
    def __init__(self, world):
        ...
        # Material
        self.attributes["manualMaterialNames"] = ["Metal", "Plastic"]
    ...
    def actionUseWith(self, patientObj):
        # Use this object on the patient object
        useDescriptionStr = (
            "You use the moisture meter to measure the moisture content of the "
            + patientObj.name
            + ".\n"
        )

        # Check if the patient object has a moisture attribute
        if "moisture" not in patientObj.attributes:
            useDescriptionStr += "The results are inconclusive. The moisture meter cannot measure this object.\n"
            return ActionSuccess(
                True, useDescriptionStr, importance=MessageImportance.HIGH
            )

        # Get the patient object's moisture
        patientMoisture = patientObj.attributes["moisture"]
        if patientMoisture is None:
            useDescriptionStr += "The results are inconclusive.\n"
            return ActionSuccess(
                True, useDescriptionStr, importance=MessageImportance.HIGH
            )

        # Report the moisture (to 2 decimal places)
        useDescriptionStr += (
            "The moisture meter reports a moisture content of "
            + "{:.2f}".format(patientMoisture)
            + " units.\n"
        )
...
class PressureMeter(Object):
    """
    Pressure meter for measuring pressure levels in objects.
    Used in causal discovery scenarios to measure the 'pressure' attribute.
    """
    ...
    def __init__(self, world):
        Object.__init__(
            ...
            "pressure meter",
            "pressure meter",
            defaultSpriteName="instruments_generic_meter",
        )
    ...
    def actionUseWith(self, patientObj):
        useDescriptionStr = (
            "You use the pressure meter to measure the pressure of the "
            + patientObj.name
            + ".\n"
        )

        if "pressure" not in patientObj.attributes:
            useDescriptionStr += "The results are inconclusive. The pressure meter cannot measure this object.\n"
            return ActionSuccess(
                True, useDescriptionStr, importance=MessageImportance.HIGH
            )

        patientPressure = patientObj.attributes["pressure"]
        if patientPressure is None:
            useDescriptionStr += "The results are inconclusive.\n"
            return ActionSuccess(
                True, useDescriptionStr, importance=MessageImportance.HIGH
            )
        ...
        useDescriptionStr += (
            "The pressure meter reports a pressure of "
            + "{:.2f}".format(patientPressure)
            + " units.\n"
        )
...
class ConductivityMeter(Object):
    """
    Conductivity meter for measuring electrical conductivity in objects.
    Used in causal discovery scenarios to measure the 'conductivity' attribute.
    """
    ...
    def actionUseWith(self, patientObj):
        useDescriptionStr = (
            "You use the conductivity meter to measure the conductivity of the "
            + patientObj.name
            + ".\n"
        )

        if "conductivity" not in patientObj.attributes:
            useDescriptionStr += "The results are inconclusive. The conductivity meter cannot measure this object.\n"
            return ActionSuccess(
                True, useDescriptionStr, importance=MessageImportance.HIGH
            )

        patientConductivity = patientObj.attributes["conductivity"]
        if patientConductivity is None:
            useDescriptionStr += "The results are inconclusive.\n"
            return ActionSuccess(
                True, useDescriptionStr, importance=MessageImportance.HIGH
            )
        ...
        useDescriptionStr += (
            "The conductivity meter reports a conductivity of "
            + "{:.2f}".format(patientConductivity)
            + " units.\n"
        )
    ...
    def actionUseWith(self, otherObject=None):
        ...
        if isinstance(otherObject, FloppyDisk):
            ...
            if floppy_disk.value == 0:
                ...
                self.flagpole.current_height = min(
                    self.flagpole.current_height + floppy_disk.value,
                    self.flagpole.height - 1,
                )
            ...
            if self.flagpole.current_height != old_height:
                ...
                useDescriptionStr = (
                    "You hear a bip from the computer but nothing happened.\n"
                )
        else:
            useDescriptionStr = "The computer is waiting for some input program.\n"
            return ActionSuccess(
                False, useDescriptionStr, importance=MessageImportance.LOW
            )
...
class FloppyDisk(Object):
    def __init__(self, world, program="empty", value=0):
        super().__init__(
            world,
            "floppy disk",
            f"floppy disk ({program})",
            defaultSpriteName="instruments2_floppy_disk",
        )
...
class ProteomicsMeter(Object):
    ...
    def actionUseWith(self, patientObj):
        # Use this object on the patient object
        useDescriptionStr = (
            "You use the proteomics meter to investigate the " + patientObj.name + ".\n"
        )
...
class GlowingRockDetector(Object):
    def __init__(self, world):
        Object.__init__(
            ...
            "rock (glowing)",
            "rock (glowing)",
            defaultSpriteName="cave1_rock_glowing",
        )
        ...
        for x in range(worldX - detectionSpan, worldX + detectionSpan + 1):
            for y in range(worldY - detectionSpan, worldY + detectionSpan + 1):
                ...
                objs = self.world.getObjectsAt(
                    ...
                    includeParts=False,
                    excludeObjectsOnAgents=False,
                    respectObscuringLowerLayers=False,
                    includeContents=True,
                )
                for obj in objs:
                    ##print("Checking object: " + obj.name + " (" + obj.type + ")  isPoisonous: " + str(obj.attributes['isPoisonous']) )
                    if (obj.type == "mushroom") and (
                        obj.attributes["isPoisonous"] == True
                    ):
                        detected = True
                        # print("\t DETECTED!")
                        break
...
class Rocket(Object):
    def __init__(self, world, part=None, isFiring=False):
        ...
        super().__init__(
            world, "rocket", "rocket", defaultSpriteName=f"launchSite_rocket_{part}"
        )
        self.part = part
...
class LaunchMonitor(Object):
    def __init__(self, world, part=None):
        ...
        super().__init__(
            world, "monitor", "monitor", defaultSpriteName=f"launchSite_monitor_{part}"
        )
        ...
        self.attributes["document"] = (
            "A lot of data is displayed on the monitor; none useful for you."
        )
...
class FuelTank(Object):
    def __init__(self, world, variant=None, part=None):
        ...
        super().__init__(
            ...
            "tank",
            "tank {variant}",
            defaultSpriteName=f"launchSite_fuel_tank_{variant}_{part}",
        )
...
class RocketryBook(Object):
    def __init__(self, world):
        super().__init__(
            ...
            "book",
            "rocketry book",
            defaultSpriteName=f"instruments2_rocketry_book",
        )
...
class LoadCell(Object):
    def __init__(self, world, part=None):
        ...
        super().__init__(
            ...
            "load cell",
            "load cell",
            defaultSpriteName=f"launchSite_load_cell_{part}",
        )
...
class LoadCellWall(Object):
    def __init__(self, world, part=None, variant="", isPassable=None):
        ...
        super().__init__(
            ...
            "load cell wall",
            "load cell wall",
            defaultSpriteName=f"launchSite_{variant}wall_{part}",
        )
